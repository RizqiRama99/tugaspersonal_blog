...
@section('slider')
    <div class="main-slider">
        ...
        <div class="px-1 py-2 bg-light" style="font-size: 32px;">
            <marquee>
                <div style="font-family: 'Pacifico', cursive;">
                    @foreach ($data['runningtexts'] as $rt)
                        <a href="{{ $rt->link }}">{{ $rt->judul }}</a> &nbsp; &nbsp;
                    @endforeach
                </div>
            </marquee>
        </div>
            ...
            @foreach ($data['sliders'] as $slider)
                <div class="ls-slide"
                    ...
                    <div class="slider-content ls-l" style="top:60%; left:30%;"
                        ...
                        <a class="btn" href="{{ $slider->url }}">{{ $slider->category->name }}</a>
